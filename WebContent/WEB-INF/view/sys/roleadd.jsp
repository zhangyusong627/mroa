...
<body>
	...
	<div class="container">
		<form action="<%=basePath %>role/add" class="form-horizontal" method="post">
			<!--以下录入表单-->
		    <div class="form-group">
		        <label for="permissionName" class="contro-label">角色代码:</label>
		        <input class="form-control" value="" id="roleName" name="roleName" type="text"/>
		    </div>
		    <div class="form-group">
		        <label for="permissionMenuName" class="contro-label">角色名称:</label>
